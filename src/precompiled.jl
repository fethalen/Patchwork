...
precompile(Tuple{Base.var"#showerror##kw", NamedTuple{(:backtrace,), Tuple{Bool}}, typeof(Base.showerror), Base.IOContext{Base.TTY}, ArgumentError, Array{Base.StackTraces.StackFrame, 1}})
precompile(Tuple{Base.var"##print_within_stacktrace#429", Symbol, Bool, typeof(Base.print_within_stacktrace), Base.IOContext{Base.TTY}, String, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.print), Base.IOContext{Base.GenericIOBuffer{Array{UInt8, 1}}}, String, Type, Vararg{Any, N} where N})
