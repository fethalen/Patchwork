...
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), Patchwork.var"#60#61"{Patchwork.SequenceIdentifier, Int64, BioAlignments.PairwiseAlignment{BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}}, Float64, Int64, Int64, Int64, Int64, Int64, String}, String, Vararg{String, N} where N})
...
precompile(Tuple{Patchwork.var"#63#65", Array{Int64, 1}})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Float64, 1}, Float64, Base.Generator{DataFrames.DataFrameColumns{DataFrames.DataFrame}, Patchwork.var"#63#65"}, Int64})
precompile(Tuple{Patchwork.var"#63#65", Array{Float64, 1}})
