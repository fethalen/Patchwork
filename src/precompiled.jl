...
precompile(Tuple{typeof(Base.map), typeof(Tables.sym), Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}})
...
precompile(Tuple{typeof(Base.Broadcast.combine_styles), Tuple{Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{Int64, 1}}}, Tuple{Nothing, Nothing}, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{Int64, 1}}}, Tuple{Array{InlineStrings.String31, 1}, Array{UInt32, 1}}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Base.Broadcast.Style{Tuple}, Function, Tuple{Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{Int64, 1}}}, Tuple{Nothing, Nothing}, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{Int64, 1}}}, Tuple{Array{InlineStrings.String31, 1}, Array{UInt32, 1}}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}, Tuple{Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{Patchwork.SequenceIdentifier, 1}, 1}, Array{Patchwork.SequenceIdentifier, 1}, Base.Generator{Base.UnitRange{Int64}, Base.var"#194#195"{Tables.var"#65#66"{Int64, Base.RefValue{Any}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}}}, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{Array{T, 1} where T, 1}, Base.Generator{Base.UnitRange{Int64}, Base.var"#194#195"{Tables.var"#65#66"{Int64, Base.RefValue{Any}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{AbstractArray{T, 1} where T, 1}, Base.Generator{Base.UnitRange{Int64}, Base.var"#194#195"{Tables.var"#65#66"{Int64, Base.RefValue{Any}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}}}, Int64, Int64})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{Patchwork.SequenceIdentifier, 1}, 1}, Array{Patchwork.SequenceIdentifier, 1}, Base.Generator{Base.UnitRange{Int64}, Base.var"#194#195"{Tables.var"#65#66"{Int64, Base.RefValue{Any}, Array{String, 1}}}}, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{Array{T, 1} where T, 1}, Base.Generator{Base.UnitRange{Int64}, Base.var"#194#195"{Tables.var"#65#66"{Int64, Base.RefValue{Any}, Array{String, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{AbstractArray{T, 1} where T, 1}, Base.Generator{Base.UnitRange{Int64}, Base.var"#194#195"{Tables.var"#65#66"{Int64, Base.RefValue{Any}, Array{String, 1}}}}, Int64, Int64})
...
precompile(Tuple{DataFrames.var"#fromcolumns##kw", NamedTuple{(:copycols,), Tuple{Nothing}}, typeof(DataFrames.fromcolumns), Tables.CopiedColumns{NamedTuple{(:queryid, :translated_querysequence, :full_querysequence, :querystart, :queryend, :queryframe, :subjectid, :subjectsequence, :subjectstart, :subjectend, :cigar, :percentidentical, :bitscore), Tuple{Array{Patchwork.SequenceIdentifier, 1}, Array{BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{Int64, 1}, Array{Int64, 1}, Array{Int64, 1}, Array{Patchwork.SequenceIdentifier, 1}, Array{BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, 1}, Array{Int64, 1}, Array{Int64, 1}, Array{String, 1}, Array{Float64, 1}, Array{Float64, 1}}}}, Array{Symbol, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Patchwork.var"#43#46", Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, Patchwork.var"#43#46"}})
...
precompile(Tuple{CSV.var"#write##kw", NamedTuple{(:append, :compress, :header, :delim), Tuple{Bool, Bool, Bool, Char}}, typeof(CSV.write), Tables.Schema{(:queryid, :translated_querysequence, :full_querysequence, :querystart, :queryend, :queryframe, :subjectid, :subjectsequence, :subjectstart, :subjectend, :cigar, :percentidentical, :bitscore), Tuple{String, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64, Int64, String, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, Int64, Int64, String, Float64, Float64}}, DataFrames.DataFrameRows{DataFrames.DataFrame}, String, CSV.Options{UInt8, UInt8, Nothing, Tuple{}, typeof(CSV._identity)}})
precompile(Tuple{CSV.var"#107#108"{Bool, Bool, Tables.Schema{(:queryid, :translated_querysequence, :full_querysequence, :querystart, :queryend, :queryframe, :subjectid, :subjectsequence, :subjectstart, :subjectend, :cigar, :percentidentical, :bitscore), Tuple{String, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64, Int64, String, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, Int64, Int64, String, Float64, Float64}}, DataFrames.DataFrameRows{DataFrames.DataFrame}, CSV.Options{UInt8, UInt8, Nothing, Tuple{}, typeof(CSV._identity)}, Array{UInt8, 1}, Int64, Int64, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}}, Base.IOStream})
...
precompile(Tuple{typeof(Base.join), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.join), Base.GenericIOBuffer{Array{UInt8, 1}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
