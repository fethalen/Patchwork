...
precompile(Tuple{typeof(Base.empty), Base.Dict{Symbol, Array{T, 1} where T}, Type{Symbol}, Type{AbstractArray{var"#s813", 1} where var"#s813"}})
precompile(Tuple{typeof(Base.merge!), Base.Dict{Symbol, AbstractArray{var"#s813", 1} where var"#s813"}, Base.Dict{Symbol, Array{T, 1} where T}})
...
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, AbstractArray{var"#s813", 1} where var"#s813"}, PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Symbol})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, AbstractArray{var"#s813", 1} where var"#s813"}, Base.Generator{Base.Iterators.Zip{Tuple{Array{Symbol, 1}, Array{AbstractArray{var"#s813", 1} where var"#s813", 1}}}, CSV.var"#25#27"}, Tuple{Int64, Int64}})
...
precompile(Tuple{Type{CSV.File{false}}, String, Array{Symbol, 1}, Array{Type, 1}, Int64, Int64, Array{AbstractArray{var"#s813", 1} where var"#s813", 1}, Base.Dict{Symbol, AbstractArray{var"#s813", 1} where var"#s813"}})
...
precompile(Tuple{typeof(Base.setindex!), Array{AbstractArray{var"#s813", 1} where var"#s813", 1}, PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Int64})
...
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{T, 1} where T, 1}, PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{AbstractArray{var"#s813", 1} where var"#s813", 1}, Base.Generator{Base.UnitRange{Int64}, DataFrames.var"#110#111"{DataFrames.DataFrame}}, Int64, Int64})
precompile(Tuple{Base.Cartesian.var"#@ncall", LineNumberNode, Module, Int64, Any, Vararg{Any, N} where N})
precompile(Tuple{typeof(DataFrames.row_group_slots), Tuple{Array{String, 1}, Array{String, 1}, Array{String, 1}, Array{Int64, 1}, Array{Int64, 1}, Array{Int64, 1}, PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Array{String, 1}, Array{Int64, 1}, Array{Int64, 1}, Array{String, 1}, Array{Float64, 1}, Array{Float64, 1}}, Base.Val{true}})
...
precompile(Tuple{typeof(DataFrames.row_group_slots), Tuple{Array{String, 1}, Array{String, 1}, Array{String, 1}, Array{Int64, 1}, Array{Int64, 1}, Array{Int64, 1}, PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Array{String, 1}, Array{Int64, 1}, Array{Int64, 1}, Array{String, 1}, Array{Float64, 1}, Array{Float64, 1}}, Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, DataFrames.IntegerRefpool{Int64}, Array{String, 1}, Nothing, DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefpool{Int64}, Nothing, Nothing, Nothing}, Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, DataFrames.IntegerRefarray{Array{Int64, 1}}, Array{UInt32, 1}, Nothing, DataFrames.IntegerRefarray{Array{Int64, 1}}, DataFrames.IntegerRefarray{Array{Int64, 1}}, Nothing, Nothing, Nothing}, Base.Val{true}, Nothing, Bool, Bool})
...
precompile(Tuple{typeof(Base.println), Base.TTY, Array{Patchwork.SequenceIdentifier, 1}})
...
precompile(Tuple{CSV.var"#write##kw", NamedTuple{(:append, :header), Tuple{Bool, Bool}}, typeof(CSV.write), Tables.Schema{(:queryid, :querysequence, :full_querysequence, :querystart, :queryend, :queryframe, :subjectid, :subjectsequence, :subjectstart, :subjectend, :cigar, :percentidentical, :bitscore), Tuple{String, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64, Int64, String, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, Int64, Int64, String, Float64, Float64}}, DataFrames.DataFrameRows{DataFrames.DataFrame}, String, CSV.Options{UInt8, UInt8, Nothing, Tuple{}, CSV.var"#61#64"}})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CSV.var"#73#74"{CSV.var"#66#67"{Bool, Bool, Tables.Schema{(:queryid, :querysequence, :full_querysequence, :querystart, :queryend, :queryframe, :subjectid, :subjectsequence, :subjectstart, :subjectend, :cigar, :percentidentical, :bitscore), Tuple{String, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64, Int64, String, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, Int64, Int64, String, Float64, Float64}}, DataFrames.DataFrameRows{DataFrames.DataFrame}, CSV.Options{UInt8, UInt8, Nothing, Tuple{}, CSV.var"#61#64"}, Array{UInt8, 1}, Int64, Int64, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}}}, String, Vararg{String, N} where N})
precompile(Tuple{typeof(CSV.writenames), Array{UInt8, 1}, Int64, Int64, Base.IOStream, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, Int64, CSV.Options{UInt8, UInt8, Nothing, Tuple{}, CSV.var"#61#64"}})
...
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), Patchwork.var"#58#59"{Patchwork.SequenceIdentifier, Int64, BioAlignments.PairwiseAlignment{BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}}, Float64, Int64, Int64, Int64, Int64, Int64, String}, String, Vararg{String, N} where N})
precompile(Tuple{typeof(Base.print), Base.GenericIOBuffer{Array{UInt8, 1}}, String, String, Vararg{Any, N} where N})
precompile(Tuple{typeof(Patchwork.write_fasta), String, Patchwork.SequenceIdentifier, Patchwork.SequenceIdentifier, BioAlignments.PairwiseAlignment{BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}}, Char})
...
precompile(Tuple{Patchwork.var"#61#63", Array{Int64, 1}})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Float64, 1}, Float64, Base.Generator{DataFrames.DataFrameColumns{DataFrames.DataFrame}, Patchwork.var"#61#63"}, Int64})
precompile(Tuple{Patchwork.var"#61#63", Array{Float64, 1}})
