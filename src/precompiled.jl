...
precompile(Tuple{DataFrames.var"#DataFrame#145#147", Bool, Type{DataFrames.DataFrame}, Array{Any, 1}, DataFrames.Index})
...
precompile(Tuple{SIMD.Intrinsics.var"##s6#114", Any, Any, Any, Any, Any, Any})
...
precompile(Tuple{SIMD.Intrinsics.var"##s6#115", Any, Any, Any, Any, Any, Any})
precompile(Tuple{SIMD.Intrinsics.var"##s6#116", Any, Any, Any, Any, Any, Any})
...
precompile(Tuple{DataFrames.var"#DataFrame#145#147", Bool, Type{DataFrames.DataFrame}, Array{AbstractArray{var"#s813", 1} where var"#s813", 1}, DataFrames.Index})
...
precompile(Tuple{typeof(Base.deleteat!), Array{String, 1}, Array{Int64, 1}})
...
precompile(Tuple{DataFrames.var"##select!#465", Bool, typeof(DataFrames.select!), DataFrames.DataFrame, Any})
...
precompile(Tuple{DataFrames.var"##manipulate#478", Bool, Bool, Bool, typeof(DataFrames.manipulate), DataFrames.DataFrame, Array{Int64, 1}})
...
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), Patchwork.var"#436#437"{String, Int64, BioAlignments.PairwiseAlignment{BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}, BioSequences.LongSequence{BioSequences.AminoAcidAlphabet}}, Float64, Int64, Int64, Int64, Int64, Int64, String}, String, Vararg{String, N} where N})
...
precompile(Tuple{DataFrames.var"##manipulate#479", Bool, Bool, Bool, typeof(DataFrames.manipulate), DataFrames.DataFrame, InvertedIndices.InvertedIndex{Array{Symbol, 1}}})
...
precompile(Tuple{Patchwork.var"#441#443", Array{Int64, 1}})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Float64, 1}, Float64, Base.Generator{DataFrames.DataFrameColumns{DataFrames.DataFrame}, Patchwork.var"#441#443"}, Int64})
precompile(Tuple{Patchwork.var"#441#443", Array{Float64, 1}})
